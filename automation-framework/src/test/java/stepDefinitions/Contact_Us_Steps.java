...
public class Contact_Us_Steps {
    ...
    public void i_enter_a_unique_email_address() {
        driver.findElement(By.xpath("//input[@name='email']")).sendKeys("AutoEmail"+generateRandomNumber(Integer.parseInt(generateRandomNumber(1)))+"@mail"+generateRandomNumber(5)+".com");
    }

    @And("I enter a unique comment")
    public void i_enter_a_unique_comment() {
        driver.findElement(By.xpath("//textarea[@name='message']")).sendKeys("Hello QA! "+generateRandomString(Integer.parseInt(generateRandomNumber(3))));
    }

    @And("I enter a specific first name {string}")
